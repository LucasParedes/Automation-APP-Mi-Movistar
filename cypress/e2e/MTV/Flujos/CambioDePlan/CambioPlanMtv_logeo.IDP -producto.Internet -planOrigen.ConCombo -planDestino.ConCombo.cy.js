...
describe('CambioPlanMtv_logeo.IDP -producto.Internet -planOrigen.ConCombo -planDestino.ConCombo', () => {
    ...
    it('Cambio de plan de MTV a otro Combo+', { tags: ['regresion', 'mtv', 'mtvFlujo'] }, () => {
        ...
        // Se valida el precio del plan seleccionado
        resumen.getMontoTotal().invoke('text').should('equal', preciosBuilder.precioPlanes('resumen').maxCombo)

        //Typ Dos Botones
        cy.visit(urlAmbiente + url.thankyoupage)
        typDosBotones.getTituloTexto().should('have.text', typDosBotonesTextos.getTituloTexto() + 'TV Max Combo+')
