...
describe('RegistrarmeEnMTV_logeo.IDP -producto.Internet -mtv.Con', () => {
    ...
    it('01 - Validar Cliente Sin MTV - Aun No tenes un Plan', { tags: ['regresion', 'mtv', 'mtvFlujo'] }, () => {
        ...
        administrarMtv.getRecuadrosGestion().eq(1).click()
        cy.wait(3000)

        cy.url().should('eq', urlAmbiente + url.mtvContratadoIdp)
        mtvContratadoIdp.getTituloTexto(1360).should('contain', mtvContratadoIdp.getTituloTextoValor())
    })
})
